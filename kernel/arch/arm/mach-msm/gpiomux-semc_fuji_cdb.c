/* arch/arm/mach-msm/gpiomux-semc_fuji_cdb.c
 *
...
static struct msm_gpiomux_config semc_fuji_all_cfgs[] __initdata = {
	...
	{ /* AP2MDM_UART_TX_DATA/AUX_TRST_N */
		.gpio = 66,
		.settings = { [GPIOMUX_SUSPENDED] = &unused_gpio, },
	},
	{ /* AP2MDM_UART_RX_DATA/AUX_TDI */
		.gpio = 67,
		.settings = { [GPIOMUX_SUSPENDED] = &unused_gpio, },
	},
	{ /* AP2MDM_UART_CTS_N/AUX_TMS */
		.gpio = 68,
		.settings = { [GPIOMUX_SUSPENDED] = &unused_gpio, },
	},
	{ /* AP2MDM_UART_RFR_N/AUX_TCK */
		.gpio = 69,
		.settings = { [GPIOMUX_SUSPENDED] = &unused_gpio, },
	},
	{ /* MLCD_RESET_N */
	...
	{ /* SDC5_MDM_D2/TSIF2_EN */
		.gpio = 98,
		.settings = { [GPIOMUX_SUSPENDED] = &unused_gpio, },
	},
	{ /* SDC5_MDM_D1/TSIF2_DATA */
		.gpio = 99,
		.settings = { [GPIOMUX_SUSPENDED] = &unused_gpio, },
	},
	{ /* SDC5_MDM_D0 */
