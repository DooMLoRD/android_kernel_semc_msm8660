/* arch/arm/mach-msm/vreg-fuji_csfb_cdb.c
 *
...
struct rpm_vreg_pdata rpm_vreg_init_pdata[RPM_VREG_ID_MAX] = {
	...
	RPM_VREG_INIT_LDO(PM8058_L6,  1, 1, 0, 3000000, 3600000,  LDO50HMIN, 0),
	RPM_VREG_INIT_LDO(PM8058_L7,  1, 1, 0, 1800000, 1800000,  LDO50HMIN, 0),
	...
	RPM_VREG_INIT_LDO(PM8058_L14, 1, 1, 0, 2850000, 2850000, LDO300HMIN, 0),
	...
	RPM_VREG_INIT_LDO(PM8058_L18, 1, 1, 1, 2200000, 2200000, LDO150HMIN, 0),
	...
	RPM_VREG_INIT_LDO_PF(PM8058_L21, 1, 1, 0, 1200000, 1200000, LDO150HMIN,
		RPM_VREG_PIN_CTRL_NONE, RPM_VREG_PIN_FN_SLEEP_B),
	RPM_VREG_INIT_LDO(PM8058_L22, 1, 1, 0, 1200000, 1200000, LDO300HMIN, 0),
	...
	RPM_VREG_INIT_SMPS(PM8901_S3, 0, 1, 0, 1100000, 1100000,   FTS_HMIN, 0,
		RPM_VREG_FREQ_1p60),
	RPM_VREG_INIT_SMPS(PM8901_S4, 1, 1, 0, 1225000, 1225000,   FTS_HMIN,
