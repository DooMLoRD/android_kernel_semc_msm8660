...
#
$(PRODUCT_OUT)/kernel.elf: $(TARGET_PREBUILT_KERNEL) $(PRODUCT_OUT)/ramdisk.img $(PRODUCT_OUT)/RPM.bin | sin-tools
	$(hide) $(HOST_OUT_EXECUTABLES)/mkelf.py \
		-o $(dir $@)/kernel-unsigned.elf \
